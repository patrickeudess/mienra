...
module.exports = (_app, t) => {
  ...
  t.ok(index.includes("production-stability.js?v=20260717-realtime-session-v3"), "deploiement: module de stabilite publie");
  t.ok(stability.includes("lastRealtimeEventAt") && stability.includes("SUBSCRIBED"), "sync: etat Realtime verifiable en production");
  t.ok(stability.includes("dataset.mienraRealtimeStatus = realtimeStatus"), "sync: etat Realtime visible par les controles de production");
  ...
  t.ok(index.includes("receipt-pdf-download.js?v=20260818-receipt-uppercase"), "recu: correctif PDF force dans le cache navigateur");
  t.ok(receiptPdf.includes('"ANNÉE SCOLAIRE"') && receiptPdf.includes('"ÉLÈVE"') && receiptPdf.includes('"RESTE À PAYER"'), "recu PDF: libelles en majuscules avec accents");
