...
// F-1 : on n'autorise que l'origine du site (défense en profondeur). Ajoutez
// ici d'autres origines si besoin (ex. un domaine personnalisé).
const ALLOWED_ORIGINS = ["https://patrickeudess.github.io"];
